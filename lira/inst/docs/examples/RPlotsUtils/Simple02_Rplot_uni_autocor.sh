...
infileAutoCor1Par = 'PoisDatons32x32EEMC2vsNullModel_Strt0.01_viaFits.autocor'
infileAutoCor2Par = 'PoisDatons32x32EEMC2vsNullModel_Strt1.00_viaFits.autocor'
...
## so, skipping:
#pdf("Simple02Autocor_0_1_LogProb.pdf", height=4.3, width=4.3 )
#
...
png("Simple02Autocor_0_1_SpinCol.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_SpinRow.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_Hyp0.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_Hyp1.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_Hyp2.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_Hyp3.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_Hyp4.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_MSCnts.png", height=320, width=320, units="px" )
...
png("Simple02Autocor_0_1_BkgPrefactor.png", height=320, width=320, units="px" )
