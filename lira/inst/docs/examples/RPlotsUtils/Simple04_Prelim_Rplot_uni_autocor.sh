...
infileAutoCor1Par = 'Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testEvsNull_Strt1.00_viaFits.autocor'
infileAutoCor2Par = 'Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testEvsNull_Strt0.01_viaFits.autocor'
...
Autocor1Hyp5 <- AutoCor1Par[[11]]
Autocor1Hyp6 <- AutoCor1Par[[12]]
Autocor1ExpMSCnts <- AutoCor1Par[[13]]
...
Autocor2Hyp5 <- AutoCor2Par[[11]]
Autocor2Hyp6 <- AutoCor2Par[[12]]
Autocor2ExpMSCnts <- AutoCor2Par[[13]]
...
## so, skipping:
#pdf("Simple04Autocor_0_1_LogProb.pdf", height=4.3, width=4.3 )
#
...
png("Simple04Autocor_0_1_SpinCol.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_SpinRow.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_Hyp0.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_Hyp1.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_Hyp2.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_Hyp3.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_Hyp4.png", height=320, width=320, units="px" )
...
png("Simple04Autocor_0_1_MSCnts.png", height=320, width=320, units="px" )
