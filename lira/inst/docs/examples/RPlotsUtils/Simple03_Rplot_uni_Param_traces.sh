...
r --vanilla <<EOF >  Simple03_Rplot_uni_Param_traces.log
##
#####    Making and pdf files of the specified data
##


infileImgDat1 = '../outputs/Simple03_Prelim_Gauss2d1.5_PoisDatons128x128testE_Strt1.00_viaFits.param'
...
infileImgDat2 = '../outputs/Simple03_Prelim_Gauss2d1.5_PoisDatons128x128testE_Strt0.01_viaFits.param'
