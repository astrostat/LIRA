...
img <- lira(
  ...
  psf.matrix = psfmat,
  start.matrix= obsmat,
  out.file = "RunOutputs/Simple_03e_PoisDatons_128x128FaintE_conv_Gauss2d_Sig_1.5_17x17.20120427a_iter60000_thin20_Strt.obs_viaFits.out",
  param.file="RunOutputs/Simple_03e_PoisDatons_128x128FaintE_conv_Gauss2d_Sig_1.5_17x17.20120427a_iter60000_thin20_Strt.obs_viaFits.par",
...
img <- lira(
  ...
  out.file = "RunOutputs/Simple_03e_PoisDatons_128x128FaintE_conv_Gauss2d_Sig_1.5_17x17.20120427a_iter60000_thin20_Strt.02.0_viaFits.out",
  param.file="RunOutputs/Simple_03e_PoisDatons_128x128FaintE_conv_Gauss2d_Sig_1.5_17x17.20120427a_iter60000_thin20_Strt.02.0_viaFits.par",
  mcmc=TRUE, fit.bkg.scale = TRUE,
  max.iter=60000, thin=20,
  burn=0,
...
img <- lira(
  ...
  out.file = "RunOutputs/Simple_03e_PoisDatons_128x128FaintE_conv_Gauss2d_Sig_1.5_17x17.20120427a_iter60000_thin20_Strt.0.02_viaFits.out",
  param.file="RunOutputs/Simple_03e_PoisDatons_128x128FaintE_conv_Gauss2d_Sig_1.5_17x17.20120427a_iter60000_thin20_Strt.0.02_viaFits.par",
  mcmc=TRUE, fit.bkg.scale = TRUE,
  max.iter=60000, thin=20,
  burn=0,
