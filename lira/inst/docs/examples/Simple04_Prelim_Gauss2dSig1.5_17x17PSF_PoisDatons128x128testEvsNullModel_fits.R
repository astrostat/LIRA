...
img <- lira(
  ...
  out.file = "RunOutputs/Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testEvsNull_Strt1.00_viaFits.out",
  param.file="RunOutputs/Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testEvsNull_Strt1.00_viaFits.param",
  mcmc=TRUE, fit.bkg.scale = TRUE,
  max.iter=300, thin=1,
  burn=0,
  alpha.init=c(3,4,5,6,7,8,9))

pdf("RunOutputs/Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testE_Strt1.00_viaFits_images.pdf", width=12, height=4.25)
par(mfrow=c(1,3))
...
img <- lira(
  ...
  out.file = "RunOutputs/Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testEvsNull_Strt0.01_viaFits.out",
  param.file="RunOutputs/Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testEvsNull_Strt0.01_viaFits.param",
  mcmc=TRUE, fit.bkg.scale = TRUE,
  max.iter=300, thin=1,
  burn=0,
  alpha.init=c(3,4,5,6,7,8,9))

pdf("RunOutputs/Simple04_Prelim_Gauss2d1.5_PoisDatons128x128testE_Strt0.01_viaFits_images.pdf", width=12, height=4.25)
par(mfrow=c(1,3))
image(obsmat, xaxt="n", yaxt="n", main="Observed Data")
